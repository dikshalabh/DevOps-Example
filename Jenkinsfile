node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u dikshal1009 -p Welcome@12345" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag c4d4b070b3de dikshal1009/myapplication" //must change your name and tag no
        sh "docker push   dikshal1009/myapplication"
  }
}
